...
public class APIException extends RuntimeException {
	...
	public static APIException buil(HttpStatus statusException, String message) {
		return new APIException(statusException, message, null);
	}
	
	public static APIException buil(HttpStatus statusException, String message, Exception e) {
